...
public class MNCBlockStationary extends BlockFluid
{
    public MNCBlockStationary(int par1, Material par2Material)
    {
        ...
        if (this.blockMaterial == Material.lava)
        {
            ...
            if (var6 == 0)
            {
                ...
                for (int var9 = 0; var9 < 3; ++var9)
                {
                    ...
                    {
                        par1World.setBlock(par2, par3 + 1, par4, Block.fire.blockID, 0, 2);
                    }
                }
            }
        }
