...
public class EntityFireTreeFX extends EntityFX
{
    ...
    public EntityFireTreeFX(World par1World, double par2, double par4, double par6, double par8, double par10, double par12)
    {
        ...
        this.particleMaxAge = (int)(Math.random() * 10.0D) + 170;
        this.noClip = true;
