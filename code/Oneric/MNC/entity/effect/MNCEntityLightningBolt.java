package Oneric.MNC.entity.effect;
...
public class MNCEntityLightningBolt extends EntityLightningBolt{
    ...
    public MNCEntityLightningBolt(World par1World, double par2, double par4, double par6, Entity summoner)
    {
        ...
        if (this.lightningState >= 0)
        {
            ...
            else
            {
                ...
                for (int l = 0; l < list.size(); ++l)
                {
                    ...
                    if(entity.equals(summoner)) return;
